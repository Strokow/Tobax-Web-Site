...
function SoundCloudIcon() {
  return (
    <svg viewBox="0 0 143 64" className="link-icon link-icon--soundcloud" aria-hidden="true">
      <path
        fill="currentColor"
...
function SpotifyIcon() {
  return (
    <svg viewBox="0 0 24 24" className="link-icon link-icon--spotify" aria-hidden="true">
      <circle cx="12" cy="12" r="10" fill="currentColor" />
      <path d="M7.2 10.2c3.2-1 6.9-.8 9.8.8" stroke="#000" strokeWidth="1.5" strokeLinecap="round" fill="none" />
      <path d="M7.9 12.8c2.6-.8 5.6-.6 7.8.6" stroke="#000" strokeWidth="1.3" strokeLinecap="round" fill="none" />
      <path d="M8.6 15.2c2-.6 4.3-.4 6 .5" stroke="#000" strokeWidth="1.2" strokeLinecap="round" fill="none" />
    </svg>
  )
}
...
function InstagramIcon() {
  return (
    <svg viewBox="0 0 24 24" className="link-icon link-icon--instagram" aria-hidden="true">
      <path
        fill="currentColor"
...
function VkIcon() {
  return (
    <svg viewBox="0 0 24 24" className="link-icon link-icon--vk" aria-hidden="true">
      <path
        fill="currentColor"
...
function YandexMusicIcon() {
  return (
    <svg viewBox="0 0 144 144" className="link-icon link-icon--yandex" aria-hidden="true">
      <path
        fill="currentColor"
  ...
  useEffect(() => {
    ...
    const detectCountry = async () => {
      try {
        ...
        if (data?.success && data?.country_code === 'RU') {
          setIsRussianIp(true)
        }
      } catch {
        setIsRussianIp(false)
      } finally {
