...
7. **Legal-risk flagging (proactive)** — whenever a proposed change or addition touches a legal/regulatory obligation, **warn the owner *before* shipping it**: state which norm applies, what the requirement is, and where misuse is risky (Abmahnung, fines, data-transfer liability). This is not legal advice — recommend a German lawyer/Anwalt review for anything material. Typical triggers: **embeds/third-party players** (DSGVO, US data transfer, cookie consent, click-to-load — see the "Embeds vs. privacy" section) · **Impressum/Datenschutz** content (§5 DDG *ladungsfähige Anschrift*, §18 Abs. 2 MStV, DSGVO Art. 13) · **newsletter / email capture** (double opt-in, DSGVO, UWG) · **forms & personal data** (booking/contact — data minimisation, consent, storage) · **news/editorial content** (MStV journalistic duties, copyright, quotation/press-image rights) · **user-generated content or analytics/tracking** (consent, TTDSG/§25 TDDDG) · **third-party media/artwork/samples** (copyright, licensing). When in doubt, flag it — err on the side of warning.
